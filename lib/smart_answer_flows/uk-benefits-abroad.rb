    ...
    def define
      ...
      country_select :which_country?, additional_countries: additional_countries, exclude_countries: exclude_countries do
        ...
        next_node do |response|
          ...
          when "jsa"
            ...
            elsif calculator.already_abroad && calculator.social_security_countries?
          ...
          when "winter_fuel_payment"
            if calculator.country_eligible_for_winter_fuel_payment?
              if calculator.going_abroad && calculator.country == "ireland" || calculator.already_abroad && calculator.country == "ireland"
                question :is_british_or_irish?
              else
      ...
      radio :worked_in_eea_or_switzerland? do
        ...
        next_node do |response|
          ...
          when "after_jan_2021"
            if calculator.benefit == "jsa" || calculator.benefit == "winter_fuel_payment" || calculator.benefit == "esa" || calculator.benefit == "disability_benefits"
